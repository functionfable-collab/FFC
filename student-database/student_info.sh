...
echo "$($PSQL "SELECT major FROM majors LEFT JOIN students ON students.major_id = majors.major_id WHERE student_id IS NULL OR LOWER(first_name) LIKE '%ma%' ORDER BY major")"
